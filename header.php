...
<a href="<?php echo get_bloginfo('url'); ?>" class="flex max-w-sm items-center space-x-3 rtl:space-x-reverse">
   <img src="<?php echo get_custom_logo(); ?>" class="h-9 max-w-xs" width="250" alt="<?php wp_title(); ?>" />
</a>
<?php }else{ ?>
...
wp_nav_menu(array(
  ...
  'li_class' => '',
  'fallback_cb' => false,
  'filter_a_nav_class' => 'block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent 
  md:border-0 md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500 md:dark:hover:bg-gray-700 dark:hover:text-white md:dark:bg-transparent'
));
?>
      <!--
