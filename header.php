...
wp_nav_menu(array(
  ...
  'menu_class' => 'font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700',
  'theme_location' => 'primary',
  'li_class' => '',
  'fallback_cb' => false,
  'filter_a_nav_class' => 'block py-2 px-3 text-white bg-blue-700 rounded-sm hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500'
));
?>
      <!--
